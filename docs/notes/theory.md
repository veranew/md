...
知道了缓存方式和实现，再来说一下缓存存在哪个地方，我们打开掘金可以看到如下的信息 。缓存的来源有两个地方 from dist cache,from memeory cache![img](https://mmbiz.qpic.cn/mmbiz_png/YBFV3Da0Nwt3kgiaBlrMnLBKrLicmicmgH2n8oBZ5CqroL8MTbGF1L17VnpWXG7EJAbha0vBje92iaJPvTIicjWyo7A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
